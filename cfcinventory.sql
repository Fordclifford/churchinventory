...
CREATE TABLE `asset` (
  ...
  `product_status` enum('good','faulty') NOT NULL,
  `product_date` date NOT NULL,
  `church_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`product_id`),
  KEY `church_id` (`church_id`),
  CONSTRAINT `asset_ibfk_1` FOREIGN KEY (`church_id`) REFERENCES `church` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=latin1;

/*Data for the table `asset` */

insert  into `asset`(`product_id`,`category_id`,`brand_id`,`product_name`,`product_description`,`product_quantity`,`product_unit`,`product_enter_by`,`product_status`,`product_date`,`church_id`) values 
(25,16,26,'test','test',1,'Pcs',11,'good','2018-10-21',1),
(26,15,25,'Chair','test',100,'Pcs',11,'good','2018-10-21',1),
(27,17,26,'testtt','ukjyasvfblaiksedxvbufpliUQEKIFKJAQMEHBF aswedfas',1,'Pcs',11,'good','2018-10-21',1),
(28,18,26,'teee','k.S dliblkSUFB Pa:KLEFB PS;bkdjfgp s;kdgfpasi;djk',1,'Pcs',11,'good','2018-10-21',1),
(29,19,27,'test','j,kwshvbfoaliwkrebfglasbkrgieaowsr',1,'Pcs',11,'good','2018-10-21',1),
(30,17,28,'Laptop','jk,Sdb flvkjsfd bvkjsdhf v',1,'Pcs',11,'good','2018-10-21',1),
(31,17,29,'Laptop',',jazhsfdvbolkjhvdkSBHajdcv',1,'Pcs',11,'good','2018-10-21',1);
...
(24,11,'XYZ','active'),
(25,15,'Fairdeal','active'),
(26,16,'Yamaha','active'),
(27,19,'Kenpoly','active'),
(28,17,'HP','active'),
(29,17,'Toshiba','active');
...
CREATE TABLE `church` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `church_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user_details` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `church` */

insert  into `church`(`id`,`user_id`,`name`,`date_added`,`date_updated`) values 
(1,11,'CFC HQ','2018-10-21 19:34:36','2018-10-21 19:34:36');
...
(27,11,371.20,'2018-10-03','Clifford Oryosa Masi','SCc\r\n4c','cash','active','2018-10-21');
...
(81,27,11,1,85.00,12.00),
(82,27,5,1,240.00,15.00);
...
(11,'amosfondo@gmail.com','$2y$10$xxMqQ20V06ltgEybQ8JeTuUAvszLTk5CEq5xtYfKoEktPVzYU8Vqu','afondo','user','Active');
