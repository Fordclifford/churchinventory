...
function count_total_churches($connect) {
    $query = "
	SELECT * FROM church";
    $statement = $connect->prepare($query);
    $statement->execute();
...
function count_total_instruments($connect) {
    $query1 = "
	SELECT * FROM category 
	WHERE category_name = 'Instruments' and category_status='active'";
    ...
    if ($_SESSION['type'] == 'master') {
        $query = "
	SELECT * FROM asset WHERE product_status='good' AND category_id='$category'";
    } if ($_SESSION['type'] == 'user') {

        $query = "
	SELECT * FROM asset WHERE product_status='good' AND category_id='$category' AND church_id='" . $_SESSION['church'] . "'";
    }
    $statement = $connect->prepare($query);
    $statement->execute();
    return $statement->rowCount();
...
function count_total_furniture($connect) {
    $query1 = "
	SELECT * FROM category 
	WHERE category_name = 'Furniture' and category_status='active'";
    $statement = $connect->prepare($query1);
    $statement->execute();
    $result = $statement->fetchAll();
    foreach ($result as $row) {
...
function count_total_library($connect) {
    $query1 = "
	SELECT * FROM category 
	WHERE category_name = 'Library' and category_status='active'";
    $statement = $connect->prepare($query1);
    $statement->execute();
    $result = $statement->fetchAll();
    foreach ($result as $row) {
...
function count_total_ict($connect) {
    $query1 = "
	SELECT * FROM category 
	WHERE category_name = 'ICT' and category_status='active'";
    $statement = $connect->prepare($query1);
    $statement->execute();
    $result = $statement->fetchAll();
    foreach ($result as $row) {
...
function count_total_kitchen($connect) {
    $query1= "
	SELECT * FROM category 
	WHERE category_name = 'kitchen' and category_status='active'";
    $statement = $connect->prepare($query1);
    $statement->execute();
    $result = $statement->fetchAll();
    foreach ($result as $row) {
...
function count_total_brand($connect) {
    $query = "
	SELECT * FROM brand WHERE brand_status='good'
	";
    $statement = $connect->prepare($query);
    $statement->execute();
    return $statement->rowCount();
...
function count_total_product($connect) {
    $query = "
	SELECT * FROM asset WHERE product_status='good'
	";
    $statement = $connect->prepare($query);
    $statement->execute();
    return $statement->rowCount();
